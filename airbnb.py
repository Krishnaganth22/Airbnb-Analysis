...
# Setting the configuration for the web app
...
with st.sidebar:
    # Sidebar having Home,Overview and Explore buttons
...
# Setting up MySQL for retrieving the cleaned and stored data in Database    
...
#Overview gives the info about the dataset and has many filters
    ...
    with tab1:
        ...
        with col1:
            # Donut plot to know about No.of reviews and Cancellation policy 
            ...
            st.write(data)
        with col2:
            # Pie chart to understand about Property type and its Price average
            ...
            st.plotly_chart(plot,use_container_width=True)
    with tab2:
        # Assigning variables for Country, Property, Room type and Price 
        ...
        # creating user interaction using filters
        ...
        with col1:
            # Plot to understand relationship between Property  type and Listings 
            ...
            #Plot to understand relationship between Host name and Listings
        ...
        with col2:
            # Plot for Room type and Listing 
            ...
            # Plot to understand relation between Country and and Total listings using Plotly choropleth
...
if selected=='Explore':
    ...
    with col1:
        # Bar plot to understand relation b/w Room type and Price
        ...
        st.plotly_chart(plot,use_container_width=True)
    with col2:
        # Scatter plot to understand Country and Average Price in each country
        ...
        st.markdown('# ')
        st.markdown('# ')
        # Scatter plot for Availability of hotels in Each country
